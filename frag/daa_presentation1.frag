...
{ 
	...
	isFlat = false;
	gain = 0.9;
	// set green to 0.4 for presentation and back to 0.1
	birth_rate = vec3(0.11, 0.1, 0.02);
	death_rate = vec3(0.06, 0.1, 0.1);

	consumption_rate = vec3(0.02, 0.06, 0.11);
	starvation_rate = vec3(0.09, 0.8, 0.0);
	minimum_resource = vec3(0.4, 0.6, 0.09);
